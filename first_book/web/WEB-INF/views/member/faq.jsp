	                ...
	                <div class="notice_body_box">
	                    <table>
		                    <c:forEach var="faq" items="${ requestScope.faqList }">
		                        <tr>
		                            <td height="40" class="tdline">${ faq.postNum } ) ${ faq.faqPostTitle } <img src="/firstbook/resources/image/under-arrow.png"></td>
		                        </tr>
		                    </c:forEach>
	                    </table>
		...
		if(document.getElementsByTagName("td")) {
			...
			for(var i = 0; i < $tds.length; i++) {
				...
				$tds[i].onclick = function() {
					...
					location.href = "${ pageContext.servletContext.contextPath }/member/faqDetail?no=" + noticeNum;
				}
			}
		}
	</script>
