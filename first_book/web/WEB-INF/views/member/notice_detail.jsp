	                    ...
	                    <div class="notice_detail">
	                        <table>
	                            <tr height="50" class="tr_underline">
	                                <td width="120">
	                                    글번호 : <c:out value="${ requestScope.notice.noticeNum }"/>
	                                </td>
	                                <td width="400">
	                                    제목 : <c:out value="${ requestScope.notice.noticeName }"/>
	                                </td>
	                                <td width="220">
	                                    작성자 : 관리자
	                                </td>
	                            ...
	                            <tr height="50" class="tr_underline">
	                                <td>
	                                	조회수 : <c:out value="${ requestScope.notice.noticeViewCount }"/>
	                                </td>
	                                <td></td>
	                                <td>
    ...
    <script>
	    if(document.getElementById("back")) {
			...
			$back.onclick = function(){
				location.href = "${ pageContext.servletContext.contextPath }/member/notice";
			}
		}
	</script>
</body>
