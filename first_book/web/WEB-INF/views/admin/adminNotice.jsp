	                ...
	                <div class="notice_body_box">
	                    <table>
		                    <c:forEach var="notice" items="${ requestScope.noticeList }">
		                        <tr>
		                            <td height="40" class="tdline">${ notice.noticeNum } ) ${ notice.noticeName } 
		                             <img src="/firstbook/resources/image/under-arrow.png">
		                            </td>
		                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label style="color:red; font-size:20px;">활성화 여부 : </label> ${ notice.noticeStatus }</td>
		                        </tr>
		                    </c:forEach>
	                    </table>
		...
		if(document.getElementsByTagName("td")) {
			...
			for(var i = 0; i < $tds.length; i++) {
				...
				$tds[i].onclick = function() {
					...
					location.href = "${ pageContext.servletContext.contextPath }/admin/noticeDetail?no=" + noticeNum;
				}
			}
		}
	</script>
